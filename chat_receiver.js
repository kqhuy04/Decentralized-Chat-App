...
const privateKey = "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d"; // Private key của 0x70997970...
...
chatContract.on("MessageSent", (sender, content, timestamp, recipient) => {
  if (sender === wallet.address || recipient === wallet.address) {
    ...
    const timestampInMs = Number(timestamp) * 1000; // Sửa cả ở đây
